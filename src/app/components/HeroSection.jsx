        ...
        <section className="lg:py-16">
            <div className="grid grid-cols-1 sm:grid-cols-12"> 
                ...
                >
                    ...
                    <p className="text-[#ADBBBE] text-base sm:text-lg mb-6 lg:text-xl">
                        Je créé du contenu pour aider les débutants à se lancer dans la programmation et la cybersécurité
                    </p>
                    <div>
                        <Link
                            href="/#contact"
                        ...
                        >
                            <span className="block bg-[#131313] hover:bg-slate-800 rounded-full px-5 py-2">
                ...
                >
                    ...
                    <Image
                        src="/images/profilPicture-removebg.png"
